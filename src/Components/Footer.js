  ...
  return (
    <footer className="container">
      <div className="footer-heading">
        <div className="brand">
          <svg className="brand-logo" viewBox="0 0 16 25" height="49" width="34" fill="#fc8019">
            <path
      ...
      <p className="footer-policy">By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy
