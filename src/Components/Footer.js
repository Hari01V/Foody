  ...
  return (
    <footer class="container">
      <div class="footer-heading">
        <div class="brand">
          <svg class="brand-logo" viewBox="0 0 16 25" height="49" width="34" fill="#fc8019">
            <path
      ...
      <div class="footer-contact">
        Contact Us: +91 98xxx-xxxxx, +91 88xxx-xxxxx
      </div>
      <p class="footer-policy">By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy
        Policy and Content Policies. All trademarks are properties of their respective owners. 2021 © Foody™ Ltd. All
        rights reserved.</p>
    </footer>
  )
}